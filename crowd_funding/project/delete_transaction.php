...
if(isset($_GET['id']))
{
	...
	$query2=pg_query("delete from transaction where transaction_id='$transaction_id'")or die('Query failed: ' . pg_last_error());
...
{
	header('location:/crowd_funding/project/view_transaction.php');
}
}
?>
</body>
