...
<html lang="en">
	...
	<center>
		...
		$results = pg_query("SELECT p1.project_id as project_id, u1.name as user_name, c1.type as category_type, p1.name as project_name,
			...
			AND p1.project_id=t1.project_id AND p1.category_id=c1.category_id GROUP BY p1.project_id, p1.user_id, p1.name, p1.description, p1.amount, 
			...
			FROM person u2, project p2, category c2 WHERE p2.user_id=u2.user_id AND p2.category_id=c2.category_id 
