...
<html lang="en">
	...
	<center>
		...
		$results = pg_query("SELECT DISTINCT p.user_id, p.project_id,p.name,p.description,p.amount,p.raised FROM project p,transaction t WHERE t.project_id=p.project_id AND t.user_id='$user_id'");
